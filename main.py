...
from models import ConvDiscriminative, ConvGenerative
...
discriminator = ConvDiscriminative()
...
def generator_loss(fake_output):
    return loss_criterion(tf.ones_like(fake_output), fake_output)


# create a loss function for discriminator
def discriminator_loss(real_output, fake_output):
    real_loss = loss_criterion(tf.ones_like(real_output), real_output)
    fake_loss = loss_criterion(tf.zeros_like(fake_output), fake_output)
